angular.module('UserModule').directive('userManageFriend', ['$compile', '$routeParams', '$route', 'User', function($compile, $routeParams, $route, User) {
	var templateAdd = '<span><i ng-click="addFriend(reloadPage)">Add as friend</i></span>',
			templateRemove = '<span><i ng-click="deleteFriend(reloadPage)">Remove this friend</i></span>',
